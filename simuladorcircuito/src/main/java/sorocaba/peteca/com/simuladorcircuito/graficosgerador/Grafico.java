...
public class Grafico extends View {
    ...
    public int ultimoPonto = 0;
    private Path pathEixos, pathGrade, pathEscala, pathCursor, pathDados, pathDadosDois, pathDadosTres, pathPontoDados;
    ...
    private void init() {
        ...
        paintDadosDois.setStrokeWidth(4);
        ...
        paintDadosTres.setStrokeWidth(4);
